...
if($invoice->igst_total <= 0){ $cs_gst_percent="@ " .($invoice->gst_rate/2)." %";
    ...
    <table style="width: 100%">
      ...
      <tr>
        <td colspan="10" rowspan="3" style="width: 100%">
          ...
          <h5 style="text-align:center;padding-top:30px;font-size:20px;margin-bottom:0px;"><b><?php echo e($company->name); ?></b>
          </h5>
    ...
    <table style="width: 100%">
      ...
      <tr>
        ...
        <td colspan="16">
          ...
          <p style="float:right">Place of Supply &nbsp;&nbsp;<b>: &nbsp;&nbsp;<?php echo e($purchaseorder->place_of_supply); ?>
        ...
        <td colspan="15" rowspan="2">
          ...
          Delivery Date &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<b>:&nbsp; &nbsp;&nbsp;&nbsp;
            <?php echo e(Carbon::parse($order_booking->delivery_date)->format('d-m-Y')); ?></b><br /><br />
          Order No &nbsp; &nbsp;&nbsp; &nbsp;&nbsp; &nbsp;&nbsp; &nbsp;&nbsp; &nbsp;<b> :&nbsp; &nbsp;
            <?php echo e($order_booking->bill_no); ?></b><br /><br />
          Order Date &nbsp; &nbsp;&nbsp; &nbsp;&nbsp; &nbsp;&nbsp; &nbsp; <b>:&nbsp; &nbsp;
            <?php echo e(Carbon::parse($order_booking->bill_date)->format('d-m-Y')); ?> </b><br /><br />
          Sales Person &nbsp; &nbsp;&nbsp; &nbsp;&nbsp; &nbsp;<b>:&nbsp; &nbsp;
            <?php echo e($bp_master->get_salesmangetFullNameAttribute??''); ?></b><br /><br />
          
          
          Customer Ref No &nbsp; &nbsp;<b>: &nbsp; &nbsp;<?php echo e($purchaseorder->customer_ref_no); ?></b><br /><br />
      ...
      * ($item->get_product->unit_case * $item->get_product->dimensions_unit_pack));
      ...
      <tr>
        ...
        <td colspan="2"><?php echo e(round($item->taxable_amount * $item->final_qty,2)); ?></td>
        ...
        <td colspan="2">
          ...
          ?>
          <?php echo e(round($item->total + $item->cgst_amount+$item->sgst_utgst_amount+$item->igst_amount,2)); ?>
      ...
      <tr>
        ...
        <td colspan="2"></td>
        <td colspan="2"><?php echo e($net_basic_total); ?></td>
      ...
      <tr>
        ...
        <td colspan="2"><?php echo e(number_format(round($total_inr, 2), 2, '.', ',')); ?></td>
      </tr>
      <tr>
      ...
      <tr>
        ...
        <td colspan="2"><?php echo e(round($discount_amount,2)); ?></td>
      </tr>

      <tr>
        <td colspan="24" class="text-right">Gross Amount</td>
        <td colspan="2"><?php echo e(number_format(round($gross_amount,2), 2, '.', ',')); ?></td>
      </tr>
      ...
      <tr>
        ...
        <td colspan="13" style="width: 50%">
          ...
          <b>Total Value after tax : <span style="float:right;">
              <?php echo e(number_format(round($gross_amount),2,'.',',')); ?></span></b><br />
      ...
      <tr>
        <td colspan="25" style="width: 100%">
          ...
          <b> <?php echo e($invoice->amount_in_words); ?></b>
        </td>
      </tr>
  ...
  <?php endif; ?><?php /**PATH C:\wamp64\www\eureka\resources\views/backend/orderbooking/invoice_format.blade.php ENDPATH**/ ?>