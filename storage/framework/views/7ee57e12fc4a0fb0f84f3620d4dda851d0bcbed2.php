                ...
                <div class="card-content">
                    <div class="card-body">
                        <div class="content-header row">
                            ...
                            <?php echo e(Form::model($model, ['url' => 'admin/purchaseorder/update', 'files' => true, 'class' =>
                            'w-100'])); ?>

                            <?php echo e(Form::hidden('financial_year', $fyear)); ?>

                            <?php echo e(Form::hidden('purchase_order_id', $model->purchase_order_id)); ?>
                            ...
                            <?php echo e(Form::hidden('purchase_order_id', null, ['id' => 'purchase_order_id'])); ?>
                                ...
                                <div class="row">
                                            ...
                                            <div class="col-sm-6">
                                                ...
                                                <div class="col-md-12 col-sm-12">
                                                    <div class="form-group">
                                                        ...
                                                        <?php echo e(Form::text('po_temp_no', $model->bill_no, [
                                                        'class' => 'form-control
                                                        po_temp_no',
                                    ...
                                    <div class="col-md-3 col-sm-3">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <?php echo e(Form::date('posting_date', date('Y-m-d'), [
                                            'class' => 'form-control
                                            ',
...
<?php echo $__env->make('backend.layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\wamp64\www\eureka\resources\views/backend/purchaseorder/edit.blade.php ENDPATH**/ ?>