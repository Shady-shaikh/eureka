            ...
            <div class="card">
                <div class="card-content">
                    <div class="card-body card-dashboard">
                        ...
                        <?php echo e(Form::open(['url' => 'admin/claims/update/' . $model->id])); ?>

                        <?php echo csrf_field(); ?>
                        <?php echo e(Form::hidden('id', $model->id, ['class' =>
                        'form-control'])); ?>
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-6 col-12 ">
                                    <div class="form-group">
                                        ...
                                        <?php echo e(Form::date('doc_date', $model->doc_date, [ 'class' => 'form-control',
                                        'readonly'=>true
                                        ])); ?>
                                ...
                                <div class="col-md-6 col-12 d-none doc_no">
                                    <div class="form-group">
                                        ...
                                        <?php echo e(Form::text('doc_no', $model->doc_no, [
                                ...
                                <div class="col-md-6 col-12 for_customer">
                                    <div class="form-label-group">
                                        ...
                                        <?php echo e(Form::select('bp_channel',[], $model->bp_channel, [
                                        'class' => 'form-control ',
                                ...
                                <div class="col-md-6 col-12">
                                    <div class="form-label-group">
                                        ...
                                        <?php echo e(Form::date('retail_dn_date',$model->retail_dn_date,['class'=>'form-control',
                                        'max'=>date('Y-m-d')])); ?>
                                ...
                                <div class="col-md-6 col-12">
                                    <div class="form-label-group">
                                        ...
                                        <?php echo e(Form::text('retail_dn_no',$model->retail_dn_no,['class'=>'form-control',
                                ...
                                <div class="col-md-6 col-12">
                                    <div class="form-label-group">
                                        ...
                                        <?php echo e(Form::text('retail_dn_desc',$model->retail_dn_desc,['class'=>'form-control',
                                ...
                                <div class="col-md-6 col-12">
                                    <div class="form-label-group">
                                        ...
                                        <?php echo e(Form::date('importer_dn_date',$model->importer_dn_date,['class'=>'form-control',
                                        'max'=>date('Y-m-d'),
                                        'required'=>true])); ?>
                                ...
                                <div class="col-md-6 col-12">
                                    <div class="form-label-group">
                                        ...
                                        <?php echo e(Form::text('importer_dn_desc',$model->importer_dn_desc,['class'=>'form-control',
                                ...
                                <div class="col-md-6 col-12">
                                    <div class="form-label-group">
                                        ...
                                        <?php echo e(Form::text('bar_code',$model->bar_code,['class'=>'form-control',
                                ...
                                <div class="col-md-6 col-12">
                                    <div class="form-label-group">
                                        ...
                                        <?php echo e(Form::month('activity_month',$model->activity_month,['class'=>'form-control',
                                ...
                                <div class="col-md-6 col-12">
                                    <div class="form-label-group">
                                        ...
                                        <?php echo e(Form::date('ret_dn_rec_date',$model->ret_dn_rec_date,['class'=>'form-control',
                                ...
                                <div class="col-md-6 col-12">
                                    <div class="form-label-group">
                                        ...
                                        <?php echo e(Form::text('location',$model->location,['class'=>'form-control',
                                ...
                                <div class="col-md-6 col-12">
                                    <div class="form-label-group">
                                        ...
                                        <?php echo e(Form::select('brand',Brands::pluck('brand_name','brand_id'),
                                        $model->brand,[
                                        'class'=>'form-control select2',
                                ...
                                <div class="col-md-6 col-12">
                                    <div class="form-label-group">
                                        ...
                                        <?php echo e(Form::select('expense_type',ExpenseTypes::pluck('expense_type_name','expense_type_id'),
                                ...
                                <div class="col-md-6 col-12">
                                    <div class="form-label-group">
                                        ...
                                        <?php echo e(Form::select('claim_type',['tts'=>'TTS'],$model->claim_type,['class'=>'form-control',
                                ...
                                <div class="col-md-6 col-12">
                                    <div class="form-label-group">
                                        ...
                                        <?php echo e(Form::text('importer_deb_note',$model->importer_deb_note,['class'=>'form-control',
                                ...
                                <div class="col-md-6 col-12">
                                    <div class="form-label-group">
                                        ...
                                        <?php echo e(Form::number('debit_value', $model->debit_value, ['class' => 'form-control',
                                        'placeholder'
                                ...
                                <div class="col-md-6 col-12">
                                    <div class="form-label-group">
                                        ...
                                        <?php echo e(Form::select('gst_value',Gstvalue::pluck('value','value') ,$model->gst_value,
                                        ['class' =>'form-control',
                                ...
                                <div class="col-md-6 col-12">
                                    <div class="form-label-group">
                                        ...
                                        <?php echo e(Form::number('total_debit_note', $model->total_debit_note, ['class' =>
                                        'form-control',
...
<script>
    ...
    $(document).ready(function(){
        ...
        if(company_id){
            var party_id = "<?php echo e($model->party_id); ?>";
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('backend.layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\wamp64\www\eureka\resources\views/backend/claims/edit.blade.php ENDPATH**/ ?>