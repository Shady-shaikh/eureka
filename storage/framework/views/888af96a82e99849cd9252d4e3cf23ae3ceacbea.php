...
<?php $__env->startSection('title', 'Focus Pack (Must Sell Pack)'); ?>
    ...
    <div class="content-header-right col-md-6 col-12 mb-md-0 mb-2">
        <div class="btn-group float-md-right" role="group" aria-label="Button group with nested dropdown">
            <div class="btn-group" role="group">
                ...
                <a class="btn btn-outline-primary" href="<?php echo e(route('admin.focusmap.create')); ?>">
...
<script>
    $(function() {
            ...
            var table = $('#tbl-datatable').DataTable({
                orderable: true,
                searchable: true,
                ajax: "<?php echo e(route('admin.focusmap')); ?>",
                columns: [{
                        data: 'DT_RowIndex',
                        name: 'DT_RowIndex'
                    },
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('backend.layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\wamp64\www\eureka\resources\views/backend/focusmap/index.blade.php ENDPATH**/ ?>