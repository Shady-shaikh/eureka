...
<?php $__env->startSection('title', 'Add Credit Note'); ?>
...
<div class="content-header row">
    <div class="content-header-left col-md-6 col-12 mb-2">
        <h3 class="content-header-title">Add Credit Note</h3>
    ...
    <div class="content-header-right col-md-6 col-12 mb-md-0 mb-2">
        <div class="btn-group float-md-right" role="group" aria-label="Button group with nested dropdown">
            <div class="btn-group" role="group">
                <a class="btn btn-outline-secondary" href="<?php echo e(route('admin.creditnote')); ?>">
                    Back
                </a>
            </div>
        </div>
                ...
                <div class="card-content">
                    <div class="card-body">
                        ...
                        <div class="content-header row">
                            ...
                            <?php echo e(Form::model([], ['url' => 'admin/creditnote/update', 'class' => 'w-100'])); ?>
                                ...
                                <div class="row">
                                    <div class="col-md-4 col-sm-4 d-none">
                                        <div class="form-group">
                                            ...
                                            <?php echo e(Form::select('t_type', ['without_inv'=>'Without Inventory'], null, [
                                            'class' => 'form-control select2',
                                            'required' => true,
                                            ])); ?>
...
<?php echo $__env->make('backend.layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\wamp64\www\eureka\resources\views/backend/creditnote/goodsreceipt_create.blade.php ENDPATH**/ ?>