...
if($invoice->igst_total <= 0){ $cs_gst_percent="@ " .($invoice->gst_rate/2)." %";
    ...
    <table class="table table-bordered table-striped table-hover" border="1">
      ...
      <tbody>
        ...
        <tr>
          ...
          <td colspan="2">Place Of Supply: <?php echo e($invoice->place_of_supply); ?></td>
          <td colspan="2">Ship From: <?php echo e($invoice->get_ship_toaddress->bp_address_name); ?></td>
        </tr>
        <tr>
        ...
        <tr>
          <td><?php echo e($i++); ?></td>
          <td colspan="2"><?php echo e($item->item_name); ?> <br> (<?php echo e($item->batch_no); ?>)</td>
  ...
  <?php endif; ?><?php /**PATH C:\wamp64\www\eureka\resources\views/backend/goodsservicereceipts/invoice_format.blade.php ENDPATH**/ ?>