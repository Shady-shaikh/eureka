...
<?php $__env->startSection('title', 'Set Scheme Price'); ?>
        ...
        <div class="row breadcrumbs-top">
            <div class="breadcrumb-wrapper col-12">
                <ol class="breadcrumb">
                    ...
                    <li class="breadcrumb-item active">Set Scheme Price : <?php echo e($pricing->pricing_name); ?></li>
                </ol>
            </div>
        </div>
    </div>
            ...
            <div class="card">
                ...
                <div class="card-content">
                    <div class="card-body">
                        ...
                        <?php echo e(Form::open(['url' => 'admin/scheme/update', 'class' => 'w-100', 'enctype' =>
                        'multipart/form-data'])); ?>
...
<script>
    var table = $('#tbl-datatable').DataTable({
            ...
            serverSide: false,
            ajax: {
                url: "<?php echo e(route('admin.scheme.form',['id'=>request('id')])); ?>", // Replace with your server-side endpoint
                type: "GET",
            },
            columns: [{
                    data: 'DT_RowIndex',
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('backend.layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\wamp64\www\eureka\resources\views/backend/marginscheme/scheme_form.blade.php ENDPATH**/ ?>