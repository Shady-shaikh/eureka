                            ...
                            <div class="card-body">
                                ...
                                <div class="form-body">
                                    <div class="row">
                                        ...
                                        <div class="col-md-6 col-12">
                                            <div class="form-group">
                                                <?php echo e(Form::label('batch_system', 'Does This Distributor Follow Batch
                                                System?
                                                *')); ?>
                                        ...
                                        <div class="col-md-6 col-12" id="is_subd_field"
                                            style="display: <?php echo e($company->db_type === 'Distributor' ? 'block' : 'none'); ?>">
                                            <br>
                                            <div class="form-check">
                                                <?php echo e(Form::checkbox('is_subd', 1, $company->is_subd == 1, ['class' =>
                                                'form-check-input', 'id' => 'is_subd'])); ?>

                                                <?php echo e(Form::label('is_subd', 'Is Subdistributor', ['class' =>
                                                'form-check-label'])); ?>
...
<?php echo $__env->make('backend.layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\wamp64\www\eureka\resources\views/backend/company/edit.blade.php ENDPATH**/ ?>