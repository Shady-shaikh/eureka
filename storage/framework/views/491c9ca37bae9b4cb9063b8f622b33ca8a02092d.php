    ...
    <div class="content-header-right col-md-6 col-12 mb-md-0 mb-2">
        <div class="btn-group float-md-right" role="group" aria-label="Button group with nested dropdown">
            <div class="btn-group" role="group">
                <a href="<?php echo e(route('admin.goodsservicereceipts')); ?>" class="btn btn-outline-secondary float-right"><i
                ...
                <div class="card-content">
                    <div class="card-body">
                        <div class="content-header row">
                            ...
                            <?php echo e(Form::model($model, ['url' => 'admin/goodsservicereceipts/update', 'files' => true,
                            'class' => 'w-100'])); ?>
                            ...
                            <?php echo e(Form::hidden('goods_service_receipt_id', $model->goods_service_receipt_id)); ?>
                                    ...
                                    <div class="col-sm-6">
                                        <div class="row">
                                            <div class="col-sm-6">
                                                ...
                                                <div class="col-md-12 col-sm-12">
                                                    <div class="form-group">
                                                        <?php echo e(Form::label('gr_temp_no', 'GOODS SERVICE RECEIPT No')); ?>

                                                        <?php echo e(Form::text('gr_temp_no', $model->bill_no, [
                                        ...
                                        <div class="row">
                                            <div class="col-12">
                                                ...
                                                <div class="conatiner-fluid table-responsive repeater">
                                                        ...
                                                        <table class="table table-bordered " id="repeater"
                                                            ...
                                                            <tbody data-repeater-list="old_invoice_items">
                                                                ...
                                                                <tr data-repeater-item class="item_row item-content"
                                                                    ...
                                                                    <td>
                                                                        <button type="button"
                                                                            id="batchDetailsModal<?php echo e($loop->index); ?>"
                                                                                                ...
                                                                                                <table
                                                                                                    ...
                                                                                                    <tr>
                                                                                                        <td>
                                                                                                            <input
                                                                                                                type="text"
                                                                                                                value="<?php echo e($items->batch_no); ?>"
                                                                                                                name="batch_no"
                                                                                                                data-name="batch_no"
                                                                                                        ...
                                                                                                        <td>
                                                                                                            <input
                                                                                                                type="date"
                                                                                                                value="<?php echo e($items->manufacturing_date); ?>"
                                                                                                        ...
                                                                                                        <td>
                                                                                                            <input
                                                                                                                type="date"
                                                                                                                value="<?php echo e($items->expiry_date); ?>"
                                                                                                                name="expiry_date"
                                                    ...
                                                    <?php else: ?>
                                                    <?php echo e(Form::hidden('old_invoice_items[' . $loop->index . '][batch_no]',
                                                    $items->batch_no, [
                                                    'class' => 'form-control
                                                    def_batch_no',
                                                    'data-name' => 'batch_no',
    ...
    <div class="col-md-3 col-sm-3">
        ...
        <div>
            <p>Discount: <strong><input type="number" name="discount" id="discount" style="width:30px;"
                        value="<?php echo e($model->discount); ?>" oninput="calculate_grand_total()">
                    %</strong>
...
<?php echo $__env->make('backend.layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\wamp64\www\eureka\resources\views/backend/goodsservicereceipts/edit.blade.php ENDPATH**/ ?>