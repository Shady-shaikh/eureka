        ...
        <div class="row mb-2">
            ...
            <div class="col-sm-6">
                <ol class="breadcrumb float-sm-right">
                    ...
                    <li class="breadcrumb-item active"><?php echo e(Request::segment(4) === 'edit' ? 'Edit' : 'Create'); ?> Gst
                        Value</li>
                </ol>
            </div>
        </div>
                            ...
                            <div class="row">
                                <div class="col-md-6 col-12">
                                    <div class="form-group">
                                        ...
                                        <?php echo e(Form::label('value', 'Percentage Value *')); ?>
...
<?php echo $__env->make('backend.layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\wamp64\www\eureka\resources\views/backend/gst_value/form.blade.php ENDPATH**/ ?>