                        ...
                        <div class="row">
                          <div class="col-md-12 col-12">
                            <div class="form-label-group">
                              ...
                              <?php echo e(Form::select('name', $departments,$role->department_id, ['class' => 'form-control', 'placeholder' => 'Select Role Name'])); ?>
                          ...
                          <div class="col-md-12 col-12">
                            <div class="form-label-group">
                              ...
                              <?php echo e(Form::label('parent_roles', 'Parent Role *')); ?>

                              <?php echo e(Form::select('parent_roles', Role::where('department_id','!=',1)->where('id','!=',request('id'))->pluck('name', 'id'), $role->parent_roles, ['class' => 'form-control
                          ...
                          <div class="col-md-12 col-12 mt-2 mb-2">
                            <div class="form-label-group">
                              <?php echo e(Form::checkbox('readonly', $role->readwrite, null, ['id'=>'readonly'])); ?>

                              <?php echo e(Form::label('readonly', 'Select All For Read Only *')); ?>

                              <span class="px-2">
                                <?php echo e(Form::checkbox('readwrite', $role->readwrite, null, ['id'=>'readwrite'])); ?>
...
<?php echo $__env->make('backend.layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\wamp64\www\eureka\resources\views/backend/roles/edit.blade.php ENDPATH**/ ?>