...
<?php $__env->startSection('title', 'View Goods Service Receipts'); ?>
...
<div class="col-sm-12 text-sm-end mb-1">
  ...
  <?php echo $__env->make('backend.goodsservicereceipts.invoice_format_split', ['roles'=>$roles,'invoice'=>$goodsservicereceipts,'party'=>$party,'download'=>false], \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
  <?php else: ?>
  <?php echo $__env->make('backend.goodsservicereceipts.invoice_format', ['roles'=>$roles,'invoice'=>$goodsservicereceipts,'party'=>$party,'download'=>false], \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
  <?php endif; ?>
      <div class="row">
        <div class="col-lg-12 text-center">
  <a href="javascript:void(0);" class="btn btn-primary" onclick="PrintElem('.printable');">Print</a>
          <a href="<?php echo e(route('admin.goodsservicereceipts')); ?>" class="btn btn-secondary">Back</a>
        </div>
      </div>
...
<?php echo $__env->make('backend.layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\wamp64\www\eureka\resources\views/backend/goodsservicereceipts/show.blade.php ENDPATH**/ ?>