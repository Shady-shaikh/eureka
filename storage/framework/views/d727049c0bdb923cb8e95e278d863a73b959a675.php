                                        ...
                                        <?php if(isset($pricings) && count($pricings) > 0): ?>
                                            ...
                                            <?php $__currentLoopData = $pricings; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $pricing): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                <tr>
                                                    ...
                                                    <td class="no_export"><a href="<?php echo e(route('admin.sellingpricing.setpricing', ['id' => $pricing->pricing_master_id])); ?>"
...
<?php echo $__env->make('backend.layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\wamp64\www\eureka\resources\views/backend/sellingpricing/index.blade.php ENDPATH**/ ?>