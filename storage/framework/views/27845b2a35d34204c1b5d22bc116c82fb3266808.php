...
<script type="text/javascript">
            ...
            updater: function(item) {
                ...
                if (customer_id || customer_id != '') {
                    if ($('#party_id').length != 0) {
                        $.ajax({
                            url: '<?php echo e(route('admin.get_customer')); ?>', // Replace with your actual API endpoint
                            method: 'GET',
                            data: {
    ...
    function loadLibrary() {
        ...
        $.getScript('<?php echo e(asset('public/backend-assets/js/bootstrap3-typeahead.min.js')); ?>', function() {
