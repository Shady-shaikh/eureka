...
<?php $__env->startSection('title', 'Beat Calendar'); ?>
                                ...
                                <thead>
                                    <tr>
                                        ...
                                        <th>
                                            <div class="my-1">
                                                <div class="dropdown">
                                                    <?php echo Form::select('beat_id', $beats, null, ['id' => 'beat_id',
                                        ...
                                        <th>
                                            <div class="my-1">
                                                <div class="dropdown">
                                                    <?php echo Form::select('beat_day', $all_data['days'], null, ['id' =>
                                        ...
                                        <th>
                                            <div class="my-1">
                                                <div class="dropdown">
                                                    <?php echo Form::select('beat_week', $all_data['week'], null, ['id' =>
                                        ...
                                        <th>
                                            <div class="my-1">
                                                <div class="dropdown">
                                                    <?php echo Form::select('beat_year', $all_data['year'], null, ['id' =>
