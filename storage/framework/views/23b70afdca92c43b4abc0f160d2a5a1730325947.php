                                            ...
                                            <div class="col-sm-6">
                                                ...
                                                <div class="col-md-12 col-sm-12 d-none doc_no">
                                                    <div class="form-group">
                                                        ...
                                                        <?php echo e(Form::text('temp_sales_order_no', $latestSoRecordNumber, [
                                                        'class' => 'form-control
                                                        temp_sales_order_no',
...
<?php echo $__env->make('backend.layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\wamp64\www\eureka\resources\views/backend/orderbooking/create.blade.php ENDPATH**/ ?>