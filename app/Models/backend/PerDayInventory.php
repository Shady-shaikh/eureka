...
class PerDayInventory extends Model
{
   ...
   * @var string
   */
  protected $table = 'per_day_inventory';
   ...
   */
  protected $fillable = [
    'warehouse_id', 'bin_id', 'batch_no', 'sku', 'doc_no','remarks', 'fy_year','company_id', 'user_id', 'item_code', 'qty', 'unit_price', 'manufacturing_date', 'expiry_date'
  ];
