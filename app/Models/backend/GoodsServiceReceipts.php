...
class GoodsServiceReceipts extends Authenticatable
{
     ...
     * @var string
     */
    protected $table = 'goods_service_receipts';
     ...
     * @var array
     */
    protected $fillable = ['discount', 'status', 'remarks', 'fy_year', 'company_id', 'is_gr_done', 'is_inventory_updated', 'vendor_inv_no', 'posting_date', 'due_date', 'document_date', 'contact_person', 'place_of_supply', 'ship_from', 'vendor_ref_no', 'purchase_order_id', 'purchase_order_counter', 'purchase_order_no', 'bill_date', 'receipt_type', 'po_document', 'party_id', 'party_details', 'financial_year', 'bill_no', 'amount_in_words', 'sub_total', 'cgst_total', 'sgst_utgst_total', 'igst_total', 'gst_grand_total', 'grand_total', 'rounded_off', 'party_name', 'bill_to_gst_no', 'company_gstin', 'vessel', 'port', 'date_of_arrival', 'date_of_departure', 'place_of_supply', 'tax_in_words', 'split_purchaseorder', 'bill_to'];
    ...
    {
        return $this->hasMany(GoodsServiceReceiptsItems::class, 'goods_service_receipt_id')->with('goods_service_receipts_batches');
    }
