...
class SelllingpricingController extends Controller
{
    ...
    {
        $pricings = Pricings::where('pricing_type', 'sale')->get();
        return view('backend.sellingpricing.index', compact('pricings'));
    }

    // //create new user
    public function create()
    {
        return view('backend.sellingpricing.create');
    }
