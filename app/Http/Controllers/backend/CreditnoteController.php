...
class CreditnoteController extends Controller
{
    ...
    public function index()
    {
        ...
        })->where('t_type', 'without_inv')->orderby('created_at', 'desc')->get();
        return view('backend.creditnote.goodsreceipt', compact('data'));
    }
    ...
    public function create()
    {
        ...
        return view('backend.creditnote.goodsreceipt_create', compact('encoded_gst', 'encoded_wh', 'series_no', 'bp_data', 'invocies', 'storage_locations', 'gst'));
    }
    ...
    public function update(Request $request)
    {
        ...
        $log = ['module' => 'Credit Note', 'action' => 'Credit Note Created', 'description' => 'Credit Note Created ' . $modal->inv_no];
        captureActivity($log);

        return redirect()->route('admin.creditnote')->with(['success' => 'Inventory Updated Successfully']);
    }
}
