!(function (i) {
    ...
    function s(i) {
        var t = i.data("settings") || { direction: "left", speed: 50 },
            ...
            n = (1e3 * s) / t.speed,
            r = {};
        return (r[t.direction] = i.css(t.direction).replace("px", "").replace("auto", "0") - s), { css: r, time: n };
    }
    function n(i) {
                    ...
                    if ((window.console, a.children("li").length < 1)) a.html(e), a.css(c.direction, "0"), l(a, !0);
                        ...
                        for (var p = e.length - 1; p >= 0; p--)
                            (o = i(e[p]).data("update")),
                                ...
                                d.length < 1
                                    ? n &&
                                      (0 === a.find(".ticker-spacer:first-child").length && a.find(".ticker-spacer").length > 0
                                          ? a.children("li.ticker-spacer").before(e[p])
                                          : ((h = i(e[p])), p === e.length - 1 && h.addClass("last"), a.find("last").after(h), a.find("last").removeClass("last")))
                                ...
                                d.length < 1
                                    ? n &&
                                      (0 === a.find(".ticker-spacer:first-child").length && a.find(".ticker-spacer").length > 0
                                          ...
                                          : ((h = i(e[u])), u === e.length - 1 && h.addClass("last"), a.find(".old.last").after(h), a.find(".old.last").removeClass("last")))
