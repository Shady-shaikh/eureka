...
@section('content')
    ...
    <div class="content-header row">
        <div class="content-header-left col-md-6 col-12 mb-2">
            <h3 class="content-header-title">Create Group</h3>
                ...
                <div class="card">
                    <div class="card-content">
                        <div class="card-body card-dashboard">
                            ...
                            {{ Form::open(['url' => 'admin/bpgroup/store']) }}
                            @csrf
                            <div class="form-body">
                                <div class="row">
                                    ...
                                    <div class="col-md-6 col-6">
                                        <div class="form-label-group">
                                            ...
                                            {{ Form::text('name', null, ['class' => 'form-control', 'placeholder' => 'Group Name', 'required' => true]) }}
                                        </div>
                                    </div>
