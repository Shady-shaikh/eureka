...
@section('title', 'View Order Fulfilment')
...
<div class="col-sm-12 text-sm-end mb-1">
  ...
  @include('backend.orderfulfilment.invoice_format_split', ['roles'=>$roles,'invoice'=>$goodsservicereceipts,'party'=>$party,'download'=>false])
  @else
  @include('backend.orderfulfilment.invoice_format', ['roles'=>$roles,'invoice'=>$goodsservicereceipts,'party'=>$party,'download'=>false])
  @endif
      <div class="row">
        <div class="col-lg-12 text-center">
  <a href="javascript:void(0);" class="btn btn-primary" onclick="PrintElem('.printable');">Print</a>
          <a href="{{ route('admin.orderfulfilment') }}" class="btn btn-secondary">Back</a>
        </div>
      </div>
