...
@section('title', 'Edit Order Fulfilment')
    ...
    <div class="content-header-right col-md-6 col-12 mb-md-0 mb-2">
        <div class="btn-group float-md-right" role="group" aria-label="Button group with nested dropdown">
            <div class="btn-group" role="group">
                <a href="{{ route('admin.orderfulfilment') }}" class="btn btn-outline-secondary float-right"><i
                ...
                <div class="card-content">
                    <div class="card-body">
                        <div class="content-header row">
                            ...
                            {{ Form::model($model, ['url' => 'admin/orderfulfilment/update', 'files' => true, 'class' =>
                            'w-100']) }}
                            ...
                            {{ Form::hidden('order_fulfillment_id', $model->order_fulfillment_id) }}
                            <div class="form-body">
                                <div class="row">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-3 col-sm-3">
                                        ...
                                        <div class="form-group">
                                            {{ Form::label('due_date', 'Delivery Date *') }}
                                                        ...
                                                        <table class="table table-bordered " id="repeater"
                                                            ...
                                                            <thead class="bg-light" style="font-size:10px;">
                                                                <tr>
                                                                    ...
                                                                    <td>{{ Form::label('price_af_discount', 'Price
                                                                        After Disocunt') }}
                                                                    </td> --}}
                            ...
                            <div class="col-sm-12 d-flex justify-content-center">
                                {{ Form::submit('Save', ['class' => 'btn btn-primary mr-1 mb-1 save_btn', 'id' => 'custom_form'])
                                }}
...
<script>
    var generateId = function(string) {
        ...
        $(document).ready(function() {
            ...
            var all_items_qty = '{{$check_all_qty}}';
            if(all_items_qty == 0){
