...
@section('title', 'View A/R Invoice')
...
<div class="content-header row">
  ...
  <div class="content-header-right col-md-6 col-12 mb-md-0 mb-2">
    <div class="btn-group float-md-right" role="group" aria-label="Button group with nested dropdown">
      <a href="{{ route('admin.arinvoice') }}" class="btn btn-secondary">Back</a>
      ...
      <div class="card">
        <div class="card-content">
          <div class="card-body">
            ...
            @include('backend.arinvoice.invoice_format_split',
            ['roles'=>$roles,'invoice'=>$goodsservicereceipts,'party'=>$party,'bill_address'=>$bill_address,'ship_address'=>$ship_address,'contact'=>$contact,'download'=>false])
            @else
            @include('backend.arinvoice.invoice_format',
            ['roles'=>$roles,'invoice'=>$goodsservicereceipts,'party'=>$party,'bill_address'=>$bill_address,'ship_address'=>$ship_address,'contact'=>$contact,'download'=>false])
            @endif
            <div class="row">
