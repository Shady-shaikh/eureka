    ...
    <table style="width: 100%">
      ...
      <tr>
        <td colspan="10" rowspan="3" style="width: 100%">
          ...
          <h5 style="text-align:center;padding-top:5px;font-size:20px;margin-bottom:0px;"><b>{{$company->name}}</b></h5>
    ...
    <table style="width: 100%">
      ...
      <tr>
        ...
        <td colspan="16">
          ...
          <p style="float:right">Place of Supply &nbsp;&nbsp;<b>: &nbsp;&nbsp;{{$goodsservicereceipts->place_of_supply}}
            </b></p><br /><br />
        </td>
        ...
        <td colspan="15" rowspan="2">
          ...
          {{-- Dispatch No. : <br /> --}}
          Delivery Date &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<b>:&nbsp; &nbsp;&nbsp;&nbsp;
            {{isset($order_booking->delivery_date)?Carbon::parse($order_booking->delivery_date)->format('d-m-Y'):''}}</b><br /><br />
          Order No &nbsp; &nbsp;&nbsp; &nbsp;&nbsp; &nbsp;&nbsp; &nbsp;&nbsp; &nbsp;<b> :&nbsp; &nbsp;
            {{$order_booking->bill_no??''}}</b><br /><br />
          Order Date &nbsp; &nbsp;&nbsp; &nbsp;&nbsp; &nbsp;&nbsp; &nbsp; <b>:&nbsp; &nbsp;
            {{isset($order_booking->bill_date)?Carbon::parse($order_booking->bill_date)->format('d-m-Y'):''}}
          </b><br /><br />
          Sales Person &nbsp; &nbsp;&nbsp; &nbsp;&nbsp; &nbsp;<b>:&nbsp; &nbsp;
            {{$bp_master->get_salesmangetFullNameAttribute??''}}</b><br /><br />
          {{-- Ack No. : <br /> --}}
          {{-- Ack Date. : <br /> --}}
          Customer Ref No &nbsp; &nbsp;<b>: &nbsp; &nbsp;{{$goodsservicereceipts->customer_ref_no}}</b><br /><br />
          {{-- Gst EwayNo. : <br /> --}}
          {{-- Eway Date. : <br /> --}}
        </td>
      </tr>
      ...
      * ($item->get_product->unit_case * $item->get_product->dimensions_unit_pack));
      ...
      <tr>
        ...
        <td colspan="2">{{ round($item->taxable_amount * $qty,2) }}</td>
        {{-- <td colspan="2">
          @php
        ...
        <td colspan="2">
          ...
          0
          @else
          {{ round($item->taxable_amount * $qty + $item->cgst_amount + $item->sgst_utgst_amount + $item->igst_amount,2)
          }}
          @endif
        </td>
      </tr>
      ...
      <tr>
        ...
        <td colspan="2"></td>
        <td colspan="2">{{ round($net_basic_total,2)}}</td>
      ...
      <tr>
        ...
        <td colspan="2">{{ number_format(round($net_basic_total, 2), 2, '.', ',') }}</td>
      </tr>
      <tr>
      ...
      <tr>
        ...
        <td colspan="13" style="width: 50%">
          ...
          <b>Total Value after tax : <span style="float:right;">
              {{number_format(round(($amount_total)-$discount_amount),2,'.',',')}}</span></b><br />
      ...
      <tr>
        <td colspan="25" style="width: 100%">
          ...
          <b> {{ amount_in_words(round($amount_total))}}</b>
        </td>
      </tr>
