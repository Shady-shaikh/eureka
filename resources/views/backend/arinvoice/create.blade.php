                                                                    ...
                                                                    <div class="row justify-content-between item-content"
                                                                        ...
                                                                        <div class="col-md-2 col-sm-12 pr-0">
                                                                            <div class="form-group">
                                                                                ...
                                                                                {{ Form::hidden('old_invoice_items[' . $loop->index . '][goods_service_receipts_item_id]', $items->goods_service_receipts_item_id, ['data-name' => 'goods_service_receipts_item_id', 'class' => 'form-control item_name typeahead', 'placeholder' => 'Description', 'required' => true, 'autocomplete' => 'off']) }}
                                                                                {{ Form::hidden('old_invoice_items[' . $loop->index . '][goods_service_receipt_id]', $goodsservicereceipt->goods_service_receipt_id, ['data-name' => 'goods_service_receipt_id', 'class' => 'form-control item_name typeahead', 'placeholder' => 'Description', 'required' => true, 'autocomplete' => 'off']) }}
