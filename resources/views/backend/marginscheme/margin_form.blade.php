...
@section('title', 'Set Margin Price')
...
<div class="content-header row">
        ...
        <div class="row breadcrumbs-top">
            <div class="breadcrumb-wrapper col-12">
                <ol class="breadcrumb">
                    ...
                    <li class="breadcrumb-item active">Set Margin Price : {{$pricing->pricing_name}}</li>
                </ol>
            </div>
        </div>
    </div>
    <div class="content-header-right col-md-6 col-12 mb-md-0 mb-2">
        <div class="btn-group float-md-right" role="group" aria-label="Button group with nested dropdown">
            <a href="{{ route('admin.margin') }}" class="btn btn-outline-secondary">Back</a>
            ...
            <div class="card">
                ...
                <div class="card-content">
                    <div class="card-body">
                        ...
                        {{ Form::open(['url' => 'admin/margin/update', 'class' => 'w-100', 'enctype' =>
                        'multipart/form-data']) }}
...
<script>
    var table = $('#tbl-datatable').DataTable({
            ...
            serverSide: false,
            ajax: {
                url: "{{ route('admin.margin.form',['id'=>request('id')]) }}", // Replace with your server-side endpoint
                type: "GET",
            },
            columns: [{
                    data: 'DT_RowIndex',
