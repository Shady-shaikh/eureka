...
<div class="content-header row">
    <div class="content-header-left col-md-6 col-12 mb-2">
        <h3 class="content-header-title">Create Beat Calender</h3>
            ...
            <div class="card">
                <div class="card-content">
                    <div class="card-body card-dashboard">
                        ...
                        {{ Form::open(['url' => 'admin/beatcalender/store']) }}
                        @csrf
                        <div class="form-body">
                            <div class="row">
                                ...
                                <div class="col-md-6 col-6">
                                    <div class="form-group">
                                        ...
                                        {{ Form::select('beat_month',$all_data['month'],null, ['class' => 'form-control
                                        tags',
                                        'placeholder' => 'Select Beat Month', 'required' => true]) }}
                                ...
                                <div class="col-md-6 col-6">
                                    <div class="form-group">
                                        ...
                                        {{ Form::select('beat_week', $all_data['week'],null, ['class' => 'form-control',
                                        'placeholder' => 'Select Beat Week', 'required' => true]) }}
                                    </div>
                                </div>
                                ...
                                <div class="col-md-6 col-6 d-none">
                                    <div class="form-group">
                                        ...
                                        {{ Form::select('beat_year',$all_data['year'],$all_data['year'][date('Y')],
                                        ['class' => 'form-control
                                        tags',
                                        'placeholder' => 'Select Beat Year', 'required' => true]) }}
