...
@section('content')
    ...
    <div class="content-header row">
        <div class="content-header-left col-md-6 col-12 mb-2">
            <h3 class="content-header-title">Create BSPL Heads</h3>
                ...
                <div class="card">
                    <div class="card-content">
                        <div class="card-body card-dashboard">
                            ...
                            {{ Form::open(['url' => 'admin/bsplheads/store']) }}
                            @csrf
                            <div class="form-body">
                                <div class="row">
                                    ...
                                    <div class="col-md-6 col-6">
                                        <div class="form-label-group">
                                            ...
                                            {{ Form::text('bspl_heads_name', null, ['class' => 'form-control', 'placeholder' => 'BSPL Head', 'required' => true]) }}
                                        </div>
                                    </div>
