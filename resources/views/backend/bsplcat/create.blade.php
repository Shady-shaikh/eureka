...
@section('content')
    ...
    <div class="content-header row">
        <div class="content-header-left col-md-6 col-12 mb-2">
            <h3 class="content-header-title">Create BSPL Category</h3>
                ...
                <div class="card">
                    <div class="card-content">
                        <div class="card-body card-dashboard">
                            ...
                            {{ Form::open(['url' => 'admin/bsplcat/store']) }}
                            @csrf
                            <div class="form-body">
                                <div class="row">
                                    ...
                                    <div class="col-md-6 col-6">
                                        <div class="form-label-group">
                                            ...
                                            {{ Form::text('bspl_cat_name', null, ['class' => 'form-control', 'placeholder' => 'BSPL Category', 'required' => true]) }}
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-md-6 col-6">
                                        <div class="form-label-group">
                                            ...
                                            {{ Form::select('bsplheads_id', $bspl_head_data,null, ['class' => 'form-control', 'placeholder' => 'Select BSPL Head', 'required' => true]) }}
                                        </div>
                                    </div>
