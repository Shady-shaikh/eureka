    ...
    <div class="content-header-right col-md-6 col-12 mb-md-0 mb-2">
        <div class="btn-group float-md-right" role="group" aria-label="Button group with nested dropdown">
            <div class="btn-group" role="group">
                @can('Create Claims')
                <a class="btn btn-outline-primary" href="{{ route('admin.claims.create') }}">
                                        ...
                                        <th>
                                            <div class="dropdown">
                                                <select name="" id="expense_type"
                                                    ...
                                                    @foreach ($expense_type as $category)
                                        ...
                                        <th>
                                            <div class="dropdown">
                                                <select name="" id="claim_type"
                                                    ...
                                                    data-bs-toggle="dropdown" aria-expanded="false">
                                                    <option value="">Select</option>
                                                    @foreach ($claim_type as $category)
                                                    <option value="{{ $category }}">{{ $category }}
                                                    </option>
                                                    @endforeach
                                                </select>
...
<script>
    var allClaimsData = {!! json_encode($allClaimsData) !!};
