            ...
            <div class="card">
                <div class="card-content">
                    <div class="card-body card-dashboard">
                        ...
                        {{ Form::open(['url' => 'admin/claims/store']) }}
                        @csrf
                        <div class="form-body">
                            <div class="row">
                                ...
                                <div class="col-md-6 col-12 ">
                                    <div class="form-group">
                                        ...
                                        {{ Form::date('doc_date', date('Y-m-d'), [ 'class' => 'form-control',
                                        'readonly'=>true
                                        ]) }}
                                    </div>
                                </div>
                                ...
                                <div class="col-md-6 col-12">
                                    <div class="form-label-group">
                                        ...
                                        {{Form::date('retail_dn_date',null,['class'=>'form-control','max' =>
                                        date('Y-m-d')])}}
                                    </div>
                                </div>
                                ...
                                <div class="col-md-6 col-12">
                                    <div class="form-label-group">
                                        ...
                                        {{Form::text('retail_dn_no',null,['class'=>'form-control',
                                ...
                                <div class="col-md-6 col-12">
                                    <div class="form-label-group">
                                        ...
                                        {{Form::text('retail_dn_desc',null,['class'=>'form-control',
                                ...
                                <div class="col-md-6 col-12">
                                    <div class="form-label-group">
                                        ...
                                        {{Form::date('importer_dn_date',null,['class'=>'form-control','max' =>
                                        date('Y-m-d'),
                                        'required'=>true])}}
                                    </div>
                                </div>
                                ...
                                <div class="col-md-6 col-12">
                                    <div class="form-label-group">
                                        ...
                                        {{Form::text('importer_dn_desc',null,['class'=>'form-control',
                                ...
                                <div class="col-md-6 col-12">
                                    <div class="form-label-group">
                                        ...
                                        {{Form::month('activity_month',null,['class'=>'form-control',
                                ...
                                <div class="col-md-6 col-12">
                                    <div class="form-label-group">
                                        ...
                                        {{Form::date('ret_dn_rec_date',null,['class'=>'form-control',
                                ...
                                <div class="col-md-6 col-12">
                                    <div class="form-label-group">
                                        ...
                                        {{Form::select('brand',Brands::pluck('brand_name','brand_id'),null,[
                                        'class'=>'form-control select2',
                                ...
                                <div class="col-md-6 col-12">
                                    <div class="form-label-group">
                                        ...
                                        {{Form::select('expense_type',ExpenseTypes::pluck('expense_type_name','expense_type_id'),null,['class'=>'form-control',
                                ...
                                <div class="col-md-6 col-12">
                                    <div class="form-label-group">
                                        ...
                                        {{Form::select('claim_type',['tts'=>'TTS'],null,['class'=>'form-control',
                                ...
                                <div class="col-md-6 col-12">
                                    <div class="form-label-group">
                                        ...
                                        {{Form::text('importer_deb_note',null,['class'=>'form-control',
                                ...
                                <div class="col-md-6 col-12">
                                    <div class="form-label-group">
                                        ...
                                        {{ Form::number('debit_value', null, ['class' => 'form-control', 'placeholder'
                                ...
                                <div class="col-md-6 col-12">
                                    <div class="form-label-group">
                                        ...
                                        {{ Form::select('gst_value',Gstvalue::pluck('value','value') ,null, ['class' =>
                                ...
                                <div class="col-md-6 col-12">
                                    <div class="form-label-group">
                                        ...
                                        {{ Form::number('total_debit_note', null, ['class' => 'form-control',
