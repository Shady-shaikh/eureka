                                ...
                                <div class="row">
                                    <div class="col-md-6 col-12">
                                        <div class="form-group">
                                            {{ Form::hidden('bussiness_partner_id', $id, ['class' => 'form-control']) }}
                                    ...
                                    <div class="col-md-6 col-12">
                                        <div class="form-group">
                                            ...
                                            {{ Form::text('bank_branch', null, ['class' => 'form-control', 'placeholder' => 'Enter Branch Name', 'required' => true]) }}
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-md-6 col-12">
                                        <div class="form-group">
                                            ...
                                            {{ Form::text('ac_number', null, ['class' => 'form-control', 'placeholder' => 'Enter Account No.', 'required' => true]) }}
                                        </div>
                                    </div>
