                                            ...
                                            <div class="col-sm-6">
                                                ...
                                                <div class=" col-12">
                                                    <div class="form-label-group">
                                                        ...
                                                        {{ Form::text('email_id', null, ['class' => 'form-control', 'placeholder' => 'Enter email(s)']) }}
                                                        {{ Form::hidden('email_ids', null, ['class' => 'form-control', 'id' => 'email_ids']) }}
                                                    </div>
                                                    <ul id="emailList"></ul>
                                                </div>
                                            ...
                                            <div class="col-sm-6">
                                                ...
                                                <div class=" col-12">
                                                    <div class="form-label-group">
                                                        ...
                                                        {{ Form::text('email_id1', null, ['class' => 'form-control', 'placeholder' => 'Enter email(s)']) }}
                                                        {{ Form::hidden('email_ids1', null, ['class' => 'form-control', 'id' => 'email_ids1']) }}
                                                    </div>
                                                    <ul id="emailList1"></ul>
                                                </div>
