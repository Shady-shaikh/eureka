...
@section('title', 'View Goods Service Receipts')
...
<div class="col-sm-12 text-sm-end mb-1">
  ...
  @include('backend.goodsservicereceipts.invoice_format_split', ['roles'=>$roles,'invoice'=>$goodsservicereceipts,'party'=>$party,'download'=>false])
  @else
  @include('backend.goodsservicereceipts.invoice_format', ['roles'=>$roles,'invoice'=>$goodsservicereceipts,'party'=>$party,'download'=>false])
  @endif
      <div class="row">
        <div class="col-lg-12 text-center">
  <a href="javascript:void(0);" class="btn btn-primary" onclick="PrintElem('.printable');">Print</a>
          <a href="{{ route('admin.goodsservicereceipts') }}" class="btn btn-secondary">Back</a>
        </div>
      </div>
