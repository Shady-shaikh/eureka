                                                                                                ...
                                                                                                <div class="modal-body">
                                                                                                    <div class="row">
                                                                                                        <div
                                                                                                            ...
                                                                                                            {{--  <input type="date" name="date[1]" data-name="date[1]">
                                                                                                                            <input type="date" name="date[2]" data-name="date[2]">
                                                                                                                            <input type="date" name="date[3]" data-name="date[3]">
                                                                                                                            <input type="date" name="date[4]" data-name="date[4]">  --}}
                                                                                                            {{--  </div>  --}}
                                                                                                            {{--  </div>  --}}
