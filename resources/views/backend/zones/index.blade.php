...
<div class="content-header row">
  <div class="content-header-left col-md-6 col-12 mb-2">
    <h3 class="content-header-title">Zone</h3>
                                        ...
                                        @foreach ($details as $data)
                                            <tr>
                                                ...
                                                <td>
                                                    ...
                                                    <a href="{{ url('admin/zones/edit/'.$data->zone_id) }}" class="btn btn-primary" title="Edit"><i class="feather icon-edit"></i></a>
                                       
                                                    {!! Form::open([
                                                        'method'=>'GET',
                                                        'url' => ['admin/zones/delete', $data->zone_id],
