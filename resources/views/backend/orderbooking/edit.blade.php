                ...
                <div class="card-content">
                    <div class="card-body">
                        <div class="content-header row">
                            ...
                            {{ Form::model($model, ['url' => 'admin/orderbooking/update', 'files' => true, 'class' =>
                            'w-100']) }}
                            {{ Form::hidden('financial_year', $fyear) }}
                            {{ Form::hidden('order_booking_id', $model->order_booking_id) }}
                            ...
                            {{ Form::hidden('order_booking_id', null, ['id' => 'order_booking_id']) }}
                            <div class="form-body">
                                <div class="row">
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-sm-6">
                                                ...
                                                <div class="col-md-12 col-sm-12 d-none only_for_ecomm_mt">
                                                    <div class="form-group">
                                                        {{ Form::label('inv_type', 'Invoice Type *') }}
                                                        {{ Form::select('inv_type',['on'=>'On','off'=>'Off'],null, [
                                                        'class' => 'form-control ]',
                                                        ...
                                                        <table class="table table-bordered " id="repeater"
                                                            ...
                                                            <thead class="bg-light" style="font-size:10px;">
                                                                <tr>
                                                                    ...
                                                                    <td class="adjust_col">
                                                                        {{ Form::label('uom', 'UOM',['style'=>'display:
