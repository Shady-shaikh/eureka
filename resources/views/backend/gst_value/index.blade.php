            ...
            <div class="card-content">
              <div class="card-body card-dashboard">
                <div class="col-12 text-right mb-2">
                  <a href="{{ route('gst_value.create') }}" class="btn btn-primary"><i class="bx bx-plus"></i>
                    Add </a>
                </div>
                      ...
                      <tr>
                        ...
                        <td class="no_export">
                          ...
                          <a class="btn btn-sm btn-primary" title="Edit"
                            href="{{route('gst_value.edit',['gst_value'=>$row->id])}}"><i
                              class="feather icon-edit"></i></a>

                      
                          <form action="{{ route('gst_value.destroy', ['gst_value' => $row->id]) }}" method="POST">
                            @csrf
                            @method('DELETE')
