                ...
                <div class="card">
                    <div class="card-content">
                        <div class="card-body card-dashboard">
                            ...
                            {{ Form::open(['url' => 'admin/beat/store']) }}
                            @csrf
                            <div class="form-body">
                                <div class="row">
                                    ...
                                    <div class="col-md-6 col-6">
                                        <div class="form-label-group">
                                            ...
                                            {{ Form::select('area_id',$area_data,'', array('class' => 'form-control select2','id'=>'area_field','placeholder'=>'Select Area','required'=>true)) }}
                                        </div>
                                    </div>
                                    ...
                                    <div class="row">
                                        <div class="col-md-6 col-6">
                                            <div class="form-label-group">
                                                ...
                                                {{ Form::text('beat_name', null, ['class' => 'form-control', 'placeholder' => 'Beat Name', 'required' => true]) }}
                                            </div>
                                        </div>
