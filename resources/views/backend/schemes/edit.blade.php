...
<div class="content-header row">
    <div class="content-header-left col-md-6 col-12 mb-2">
        <h3 class="content-header-title">Update Offer</h3>
            ...
            <div class="card-body">
              ...
              {!! Form::model($schemes, [
                ...
                'class' => 'form'
                                ...
                                {{ Form::hidden('coupon_id', $schemes->schemes_id) }}
<div class="row">
                ...
                <div class="form-group col-md-6 col-lg-6 {{ $errors->has('min_product_qty') ? 'has-error' : ''}}">
            ...
            <div class="form-group col-lg-6 col-md-6 {{ $errors->has('free_product_qty') ? 'has-error' : ''}}">
                {!! Form::label('free_product_qty', 'Free Product Qty: ', ['class' => ' control-label']) !!}
                <div class="">
