...
@section('title', 'View Banking Payment')
...
<div class="col-sm-12 text-sm-end mb-1">
  ...
  @include('backend.bankingpayment.invoice_format_split', ['roles'=>$roles,'invoice'=>$purchaseorder,'party'=>$party,'banking_items'=>$bill_booking_items,'download'=>false])
  @else
  @include('backend.bankingpayment.invoice_format', ['roles'=>$roles,'invoice'=>$purchaseorder,'party'=>$party,'banking_items'=>$bill_booking_items,'download'=>false])
  @endif
      <div class="row">
        <div class="col-lg-12 text-center">
  <a href="javascript:void(0);" class="btn btn-primary" onclick="PrintElem('.printable');">Print</a>
          <a href="{{ route('admin.bankingpayment') }}" class="btn btn-secondary">Back</a>
        </div>
      </div>
