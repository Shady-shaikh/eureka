    ...
    <div class="content-header-right col-md-6 col-12 mb-md-0 mb-2">
        <div class="btn-group float-md-right" role="group" aria-label="Button group with nested dropdown">
            <div class="btn-group" role="group">
                <a class="btn btn-outline-secondary" href="{{ route('admin.creditnote') }}">
                    Back
                </a>
            </div>
        </div>
                ...
                <div class="card-content">
                    <div class="card-body">
                        ...
                        <div class="content-header row">
                            ...
                            {{ Form::model([], ['url' => 'admin/creditnote/update', 'class' => 'w-100']) }}
                                ...
                                <div class="row">
                                    <div class="col-md-4 col-sm-4 d-none">
                                        <div class="form-group">
                                            ...
                                            {{ Form::select('t_type', ['without_inv'=>'Without Inventory'], null, [
                                            'class' => 'form-control select2',
                                            'required' => true,
                                            ]) }}
                                        </div>
    ...
    function get_data_display(customer_id) {
        ...
        $(document).ready(function() {
            ...
            $("#bp_id").on('change', function() {
                ...
                new DynamicDropdown('{{ route('admin.get_ar_invoices') }}',
                    $(this).val(), '#inv_no');
