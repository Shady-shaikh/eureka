...
<link rel="stylesheet" type="text/css"
    href="https://cdn.datatables.net/fixedcolumns/3.2.6/css/dataTables.fixedColumns.min.css">
...
<script type="text/javascript" src=" {{ asset('public/frontend-assets/js/registration-pass-hideshow.js') }}"></script>
